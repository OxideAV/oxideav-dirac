...
| Dirac core-syntax inter **decode**  | OBMC motion-comp + §11.3 residue; intra refs bit-exact, inter pictures still ReportOnly (motion-comp + §13.2.1 inter dequant-offset gap) |
