...
| Encoder — Dirac inter               | 1-ref, sub-pel ME (qpel default), OBMC, no residue. ≥30 dB self-PSNR on integer-pel translation; ~52 dB Y on a quarter-pel camera-pan fixture (vs ~27 dB at integer-pel). |
