...
| Encoder — VC-2 HQ intra             | Implemented (8/10-bit, 4:2:0/4:2:2/4:4:4, 6 wavelets). **Round-111**: optional §12.4.5.3 custom quant matrix (`custom_quant_matrix` flag + `with_custom_quant_matrix`; default emits the Annex E.1 default). |
