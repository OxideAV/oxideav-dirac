...
## [0.0.10](https://github.com/OxideAV/oxideav-dirac/compare/v0.0.9...v0.0.10) - 2026-08-01

### Other

- state the oracle posture without a denial clause
- oracle wording in the emit_hq_stream example header
- round-436 rollup — container-tag co-claim, reference P/GOP encode, oracle hygiene
- refer to the black-box validator as the oracle throughout prose
- chained-driver arms (P-chain + GOP shapes, deep pathological budget)
- deep-colour (u16) coverage of the P-chain and GOP drivers
- GOP-structured I/P/B sequence driver with unified residue rate control
- bipred residue rate-control qindex picker
- reference P pictures (0x0D) + closed-loop P-chain rate-controlled driver
- co-claim the shared legacy tags with an evidence probe
